...
public class BlockedPageRank {
	...
	public static void main(String[] args) throws Exception {
		...
		String outputPath = args[0] + "/output_block/";
		...
		do {
			...
			conf.setJobName("blockedPageRank_" + i);
			...
			avgResidualError = rj.getCounters().getCounter(BlockCounter.RESIDUAL_COUNTER) * 1.0/ MULTIPLE / NUMBER_OF_NODES;
			rj.getCounters().findCounter(BlockCounter.RESIDUAL_COUNTER).setValue(0);
			reducerCounter = rj.getCounters().getCounter(BlockCounter.REDUCER_COUNTER);
			rj.getCounters().findCounter(BlockCounter.REDUCER_COUNTER).setValue(0);
			innerIterationCounter = rj.getCounters().getCounter(BlockCounter.INNER_ITERATION_COUNTER);
			rj.getCounters().findCounter(BlockCounter.INNER_ITERATION_COUNTER).setValue(0);
